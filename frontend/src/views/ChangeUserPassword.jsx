...
function ChangeUserPassword() {
  ...
  const handleChangePassword = async () => {
    try {
      await axios.put('http://website-load-balancer-903681776.eu-north-1.elb.amazonaws.com/api/v1/users/profile/updatePassword', { password, confirm_password }, { withCredentials: true });
      await axios.get('http://website-load-balancer-903681776.eu-north-1.elb.amazonaws.com/api/v1/users/logout', { withCredentials: true });
      navigate('/');
      //navigate('/profile');
    } catch (error) {
