    ...
    <Navbar isBordered className="fixed top-0 left-0 w-full bg-white z-50">
      <NavbarContent justify="start">
        <NavbarBrand className="mr-4 flex items-center">
          ...
          <p className="hidden sm:block font-bold text-inherit">PASSWORD MANAGER</p>
        </NavbarBrand>
      ...
      <NavbarContent as="div" className="items-center" justify="end">
        ...
        <Dropdown placement="bottom-end">
          ...
          <DropdownMenu aria-label="Profile Actions" variant="flat">
            ...
            <DropdownItem key="Edit_Profile" textValue="Edit Profile" onClick={handleHome}>Home</DropdownItem>
